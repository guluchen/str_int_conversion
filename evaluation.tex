...
\begin{table}[h]
\centering
\caption{Results of {\tool}, CVC4, and Z3 on Basic String Constraint benchmarks.}
\scalebox{0.85}{
...
\begin{table}[h]
\centering
\caption{Results of {\tool}, CVC4, and Z3 on Basic String Constraints + String-Number Conversion benchmark.}
\scalebox{0.8}{

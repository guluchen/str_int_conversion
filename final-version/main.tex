...
\changed{Although this toy example is seemingly trivial, all the string constraint solvers we tried (including Z3, CVC4, and Z3Str3) cannot solve it within 10 minutes. }

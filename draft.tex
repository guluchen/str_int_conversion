...
The following construction of the so called synchronisation formula of two PFA $A$ and $A'$ is a crucial component of building overapproximations \yfc{under-approximation} of string constraints. 
...
namely, it characterises the set of pairs of encodings $(I\cup \pim)\in \parikhof {A}$ and $(I'\cup \pim')\in\parikhof {L(A')}$ such that 

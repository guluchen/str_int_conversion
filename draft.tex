...
$$\begin{array}{lc}
1&	value_0 \in [0,9]^+ \wedge 	sum_0 = 0 \wedge \\
...
8&	last_0 = \chatAt{\its{sum_2}}{|\its{sum_2}|-1} \wedge\\
9&	last_0 ==``0"
\end{array}$$

\yfc{explain the constraints and say all membership, concatenation, length, string-number conversion are required.}

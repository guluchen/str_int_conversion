...
\begin{lemma}\label{lemma:eqcorrect} For all $w_1 \in \semof{A_{x_1}} \ldots w_m \in \semof{A_{x_m}}$, we have 
	...
	\begin{center}
		...
		iff\\
		$w_1\cdot w_2 \cdots w_n = w_{n+1}\cdot w_{n+2} \cdots w_m$ and\\
		$\forall i,j \in [1,m]: x_i=x_j \Longrightarrow w_i=w_j$.
	\end{center}
\end{lemma}

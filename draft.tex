...
\yfc{Some attempts to define both encodes and decodes of PA, need more explanation of why we define them I guess. I just found that we have not defined the restriction of the domain of functions such as $e_{V}$,  maybe need it somewhere.}
\changed{

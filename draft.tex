...
from $\parikhof x(v_0) = \parikhof x(v_1) = \cdots = \parikhof x(v_{m-1})=1$ and $\parikhof x(v^0_1)=\parikhof x(v^1_1)=\parikhof x(v^2_1)=2$, then $x=v_0(v^0_1v^1_1v^2_1)^2v_1\cdots v_{m-1}$. 

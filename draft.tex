...
%
Further, if $I \cup I'$ is an ainterpretation of a general string constraint, that is, an interpretation $I$ of string variables $X$ united with an interpretation $I'$ of integer variables $N$,
%
then its $R$-encoding is defined as the set $\encode R {(I\cup I')} \defeq \{e \cup I' \mid e\in \encode R(I)\}$ of interpretations of variavbles $V_R \cup \#V_R \cup N$. 
%
...
$$
Last, since this restriction is meanigfull only when the string is indeed a numeral,  

...
The $\decode \dr$ function maps a word encoding $I_e: V_\dr\cup\#V_\dr\rightarrow \nat$ paired with an interpretation of integer variables $I_z$ to a model $I_s \cup I_z$ of a string constraint. 
Formally, 
...
we let $\encode \dr (I_s \cup I_z) \defeq \{I_e\cup I_z\mid \decode \dr (I_e\cup I_z) = I_s \cup I_z \}$.

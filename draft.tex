...
\footnote{In these examples, we use the shorthand $(x_1,\ldots,x_k)\rightarrow(n_1,\ldots,n_k)$ denote the function $\{x_1 \rightarrow n_1,\ldots, x_k\rightarrow n_k\}$.}
\end{example}

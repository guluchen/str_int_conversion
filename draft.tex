...
$\parikhof w$ that maps every character $a\in\Sigma$ to the number of its occurrences in $w$, i.e., $\parikhof w (a) = |w|_a$. 
...
Each symbolic string may be interpreted as a string over $\Sigma$, given an assignment of characters to its character variables.  
%
...
\section{Flat Under-approximation for Equalities and Regular Constraints} \label{section:eq}
...
\todo{talk about the design principle}

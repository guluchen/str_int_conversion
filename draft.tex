...
Even, more crucially, in many programming languages, the conversion between strings and integers is a part of the definition of the the core  semantics of the language. 

...
The Parikh image of a language $L$ is defined as folllows $\parikhof L = \{\parikhof w \mid w \in L\}$. %and the Parikh image of an FA $A$ is Parikh image of its language, $\parikhof{A} = \parikhof{L(A)}$. 
%
...
\yfc{I just found that we have not defined the restriction of the domain of functions such as $e_{V}$,  maybe need it somewhere. }

\yfc{Some attempts to define both encodes and decodes of PA, need more explanation of why we define them I guess. It is planed to be a replacement of the text below him. One interesting observation: the definitions of both are almost the same

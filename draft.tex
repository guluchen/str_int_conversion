...
%
An $R$-encoding of $I \cup I'$ is a union  $e \cup I'$ of an encoding $e\in \encode R(I)$ and the original integer interpretation $I'$ which satisfies that for every string leght variable $|x|$ in the domain of $I'$,
$|x| = \sum_{v\in V_x,I(v)\neq\epsilon}\#v$. 

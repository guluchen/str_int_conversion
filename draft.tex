...
Our procedure iteratively searches for chains in the equality constraints, breaks the chain by replacing some variable in the dependency circle to a fresh one, and repeats until all chains are broken.

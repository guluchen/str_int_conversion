...
%
then its $R$-encoding is defined as the set $\encode R {(I\cup I')} \defeq \{e \cup I' \mid e\in \encode R(I)\}$ of interpretations of variables $V_R \cup \#V_R \cup N$. That is, the interpretation of string variables is encoded and the interpretation of integer variables is kept as is.
%
